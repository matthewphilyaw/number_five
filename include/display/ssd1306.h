...
void ssd1306_drawChar(int16_t x, int16_t y, unsigned char c, uint16_t color, uint16_t bg, uint8_t size);
void ssd1306_writeChar(uint8_t c);

extern void ssd1306_hard_reset(void);
extern void ssd1306_write(uint8_t *buffer, uint16_t length);
